...
var body, front, propeller, wingLeft, wingRight, verticalStabilizer, rightStabilizer, leftStabilizer, cockpit;
...
function createCameraPerspective() {
	...
	cameraPerspective.position.set(0,0,150);
